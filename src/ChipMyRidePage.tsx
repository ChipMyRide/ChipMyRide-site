      ...
      <div className="w-full max-w-screen-xl mx-auto pt-0">
        ...
        <div className="flex flex-col items-center mt-12 px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-5xl mx-auto">
            {["Stage 1","Stage 2","Stage 3","Eco Tuning","Pops & Bangs","Vmax Aufhebung / Drehzahlbegrenzer","DPF / AGR / OPF Abschaltung","Getriebeoptimierung","VCDS Codierung","VCDS Kombo"].map((name, index) => {
